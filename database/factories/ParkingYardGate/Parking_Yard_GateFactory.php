...
class Parking_Yard_GateFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            "odometer_km"=>($Vh_Type==1||$Vh_Type==2)?rand(9999,999999):null,
            ...
            "vehicle_capacity_id"=>($Vh_Type!=1 && $Vh_Type!=2)?rand(1,5):null,
            ...
            "vehicle_body_type_id"=>($Vh_Type!=1 && $Vh_Type!=2)?rand(1,2):null,
