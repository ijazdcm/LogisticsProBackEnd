    ...
    public function store(Request $request, FileHelper $helper)
    {
        ...
        if(!$vendor_info){
            ...
            $vehicle_document = Vehicle_Document::create([
                ...
                "aadhar_copy" => ($request->aadhar_copy) ?  $helper->storeImage($request->aadhar_copy, Vehicle_Document::AADHAR_COPY_PATH) : '',
                "pan_copy" => ($request->pan_copy) ? $helper->storeImage($request->pan_copy, Vehicle_Document::PAN_COPY_PATH) : '',
                "bank_pass_copy" => ($request->pass_copy) ? $helper->storeImage($request->pass_copy, Vehicle_Document::BANK_PASS_COPY_PATH) : '',
                ...
                "insurance_copy_front" => ($request->insurance_copy_front) ? $helper->storeImage($request->insurance_copy_front, Vehicle_Document::INSURANCE_COPY_FRONT_PATH) :'',
                "insurance_copy_back" => ($request->insurance_copy_front) ? $helper->storeImage($request->insurance_copy_front, Vehicle_Document::INSURANCE_COPY_BACK_PATH) :'',
