...
use App\Http\Controllers\VehicleInspection\VehicleInspectionMasterController;
 ...
 */
Route::apiResource('VehicleInspection',VehicleInspectionMasterController::class);
